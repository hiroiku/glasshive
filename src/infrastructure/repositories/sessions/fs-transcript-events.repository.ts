...
/* fd から 1 行を読む。改行が見付かるまで、決めた単位で読み進む。
   ...
   短い行ばかりの正本で無駄が出て、小さく取ると長い行で何度も読み直すことになる。 */
